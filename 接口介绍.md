...
libgpiod 是一个用于访问 Linux GPIO 设备的 C 库。它提供了一种简单、易用的 API，便于控制 GPIO 引脚。

源项目地址：[libgpiod](https://github.com/starnight/libgpiod)  
案例：[案例](https://github.com/starnight/libgpiod-example)
